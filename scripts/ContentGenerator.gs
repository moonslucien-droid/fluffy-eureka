...
function redigerArticleLucasLunes(contexte, dossierRecherche) {
  var systemPrompt = [
    ...
    "",
    "5. TROIS COMPAGNONS DE VISITE (OBLIGATOIRE — NE JAMAIS OMETTRE)",
    "   Lucas ne visite PAS seul. Il est accompagné de TROIS touristes intellectuels qu'il rencontre",
    "   juste avant d'arriver au lieu ou dès les premiers pas sur le site. Ils visitent ENSEMBLE.",
    "",
    "   COMPAGNE 1 — UNE FEMME",
    "   Prénom, âge approximatif, origine (Belgique, France, Espagne ou Portugal).",
    "   Profession ou passion intellectuelle (historienne, prof de lettres, architecte, lectrice passionnée…).",
    "   Un détail physique ou vestimentaire distinctif.",
    "   Elle a un REGARD PARTICULIER sur le lieu : elle remarque des détails que les autres ne voient pas.",
    "   Elle intervient régulièrement dans le récit avec des réflexions, des questions, des commentaires cultivés.",
    "   MINIMUM 2 répliques de dialogue réparties dans l'article.",
    "",
    "   COMPAGNON 2 — UN HOMME",
    "   Prénom, âge approximatif, origine (Belgique, France, Espagne ou Portugal — différente de la compagne 1).",
    "   Profession ou passion intellectuelle différente de la compagne 1.",
    "   Un détail physique ou vestimentaire distinctif.",
    "   Il apporte un CONTREPOINT : là où l'une est contemplative, il est pragmatique (ou inversement).",
    "   Il interagit avec Lucas ET avec les autres compagnons — pas seulement avec le lieu.",
    "   MINIMUM 2 répliques de dialogue réparties dans l'article.",
    "",
    "   COMPAGNE 3 — UNE AUTRE FEMME",
    "   Prénom, âge approximatif, origine (Belgique, France, Espagne ou Portugal — différente des deux autres).",
    "   Profession ou passion intellectuelle différente des deux autres.",
    "   Un détail physique ou vestimentaire distinctif.",
    "   Elle est la plus ÉMOTIVE ou la plus INTUITIVE du groupe.",
    "   C'est elle qui pose la question qui fait réfléchir tout le monde, ou qui fait le lien inattendu.",
    "   MINIMUM 2 répliques de dialogue réparties dans l'article.",
    "",
    "   RÈGLES DES COMPAGNONS :",
    "   - Ils sont PRÉSENTS tout au long de la visite, pas juste mentionnés au début.",
    "   - Ils RÉAGISSENT à ce qu'ils voient : une inscription, une voûte, une lumière, un détail architectural.",
    "   - Ils DISCUTENT entre eux et avec Lucas — conversations naturelles, pas des monologues.",
    "   - Lucas joue le rôle de guide informel : il partage ce qu'il sait, mais écoute aussi.",
    "   - Les compagnons enrichissent le récit par leurs perspectives DIFFÉRENTES sur le même lieu.",
    "   - Ils sont fictifs mais plausibles. Pas de caricature.",
    "",
    "5b. TROIS PERSONNAGES DU LIEU — SCÈNES DE RENCONTRE (OBLIGATOIRE)",
    "   En plus des compagnons, Lucas et son groupe croisent TROIS personnes liées au lieu.",
    "   Chaque rencontre est une SCÈNE VIVANTE. Les compagnons peuvent réagir ou participer à l'échange.",
    "",
    "   PERSONNAGE 1 — LE LOCAL (celui qui connaît le lieu)",
    "   Un habitant, un gardien, un artisan, un ancien du village. Il est là depuis toujours.",
    "   Lucas (ou un compagnon) le SURPREND en pleine action. Un ÉCHANGE s'engage.",
    "   Son dialogue RÉVÈLE un secret, un souvenir, une anecdote que seul un habitant connaît.",
    "   MINIMUM 4 phrases. Prénom, détail physique, lieu précis dans le site.",
    "",
    "   PERSONNAGE 2 — LE VOYAGEUR DE PASSAGE (quelqu'un d'autre sur le site)",
    "   Un autre touriste, un randonneur, un photographe. Il vient d'ailleurs.",
    "   Un échange naît naturellement. Son dialogue reflète l'ÉMERVEILLEMENT du visiteur extérieur.",
    "   MINIMUM 4 phrases. Prénom, nationalité ou origine, geste caractéristique.",
    "",
    "   PERSONNAGE 3 — L'INATTENDU (celui qui change la perspective)",
    "   Un enfant, un artiste, un pèlerin, quelqu'un d'improbable dans ce lieu.",
    "   Sa présence SURPREND le groupe. Ce moment apporte une ÉMOTION — le moment de grâce de l'article.",
    "   MINIMUM 4 phrases. Prénom ou description, détail marquant.",
    "",
    "   RÈGLES SCÉNIQUES :",
    "   - Les trois rencontres sont ESPACÉES dans le récit (début, milieu, fin de visite), PAS regroupées.",
    "   - Chaque scène a un DÉCOR précis dans le site.",
    "   - Chaque scène a un DIALOGUE : au moins 2 répliques échangées.",
    "   - Les COMPAGNONS peuvent réagir aux personnages rencontrés (commentaire, question, sourire).",
    "   PAS de sous-titre. Tout s'intègre naturellement dans le flux du récit.",
    "",
    ...
    "- Si tu oublies les trois compagnons, les trois personnages du lieu, la question, l'invitation, la signature ou les hashtags, l'article est REJETÉ.",
    "",
  ...
  var userPrompt = [
    ...
    "☐ TROIS COMPAGNONS de visite (2 femmes + 1 homme, touristes intellectuels, présents tout au long)",
    "☐ TROIS PERSONNAGES DU LIEU (le local, le voyageur de passage, l'inattendu)",
...
function reecritureFinaleLucasLunes(contexte, brouillonCorrige) {
  var systemPrompt = [
    ...
    "",
    "1. TROIS COMPAGNONS DE VISITE — Lucas visite AVEC 3 touristes intellectuels :",
    "   - COMPAGNE 1 (femme, origine belge/française/espagnole/portugaise, intellectuelle)",
    "   - COMPAGNON 2 (homme, origine différente, contrepoint intellectuel)",
    "   - COMPAGNE 3 (femme, origine différente des deux autres, la plus émotive/intuitive)",
    "   Ils sont PRÉSENTS tout au long du récit, réagissent, discutent entre eux et avec Lucas.",
    "   Chacun a au moins 2 répliques de dialogue réparties dans l'article.",
    "   Si le brouillon ne contient pas ces 3 compagnons, tu DOIS les AJOUTER.",
    "",
    "1b. TROIS PERSONNAGES DU LIEU — En plus des compagnons, le groupe croise 3 personnes :",
    "   - PERSONNAGE 1 (LE LOCAL) : habitant/gardien, dialogue qui révèle un secret du lieu.",
    "   - PERSONNAGE 2 (LE VOYAGEUR DE PASSAGE) : autre touriste, émerveillement extérieur.",
    "   - PERSONNAGE 3 (L'INATTENDU) : présence surprenante, moment de grâce/émotion.",
    "   Chaque rencontre : MINIMUM 4 phrases, décor précis, 2 répliques de dialogue.",
    "   Les 3 rencontres sont ESPACÉES dans le récit. Les compagnons peuvent réagir.",
    "   Si le brouillon n'en contient pas 3, ou si les personnages sont plats, les RÉÉCRIRE.",
    "",

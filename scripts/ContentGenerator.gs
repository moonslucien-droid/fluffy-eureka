...
function redigerArticleLucasLunes(contexte, dossierRecherche) {
  var systemPrompt = [
    ...
    "",
    "5. TROIS VISITEURS (OBLIGATOIRE — NE JAMAIS OMETTRE)",
    "   Introduis exactement TROIS visiteurs rencontrés au lieu :",
    "   - VISITEUR 1 : Un personnage avec un prénom, un geste précis, une phrase de dialogue. Il perçoit le lieu d'une manière unique.",
    "   - VISITEUR 2 : Un personnage différent du premier, avec son propre rapport au lieu. Contraste avec le premier.",
    "   - VISITEUR 3 : Un personnage qui apporte une perspective inattendue ou émotive.",
    "   - Chaque visiteur doit avoir au MINIMUM 3 phrases qui lui sont dédiées.",
    "   - Ils sont fictifs mais plausibles : un nom, un âge approximatif, un détail physique ou vestimentaire.",
    "   - Chacun DOIT avoir au moins une ligne de dialogue entre guillemets.",
    "   - Ils apparaissent naturellement dans le récit, PAS regroupés en liste.",
    "   PAS de sous-titre.",
    "",
...
function reecritureFinaleLucasLunes(contexte, brouillonCorrige) {
  var systemPrompt = [
    ...
    "",
    "1. TROIS VISITEURS — L'article DOIT contenir exactement 3 visiteurs fictifs mais plausibles.",
    "   Chaque visiteur a : un prénom, un détail physique/vestimentaire, au moins une ligne de dialogue,",
    "   et au minimum 3 phrases qui lui sont dédiées. Ils sont dispersés dans le récit, pas regroupés.",
    "   Si le brouillon n'en contient pas 3, tu DOIS en ajouter pour atteindre 3.",
    "",
